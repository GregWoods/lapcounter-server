// Green-flag icon (same artwork as the header RaceFlagStart control), extracted
// as a standalone SVG icon for reuse. Sizing/colour via props or CSS.
//   <GreenFlagIcon width="1.5em" className="..." />
function GreenFlagIcon({ width = '1.5em', className }) {
    return (
        <svg
            width={width}
            viewBox="0 0 2399.5 2304"
            preserveAspectRatio="xMidYMid meet"
            className={className}
            aria-hidden="true"
        >
            <path fill="#063" d="M335.8,1345.9C151.3,819,0.2,386.8,0,385.6c-0.4-2,102.6-49.6,107.3-49.6c1,0,743.2,1889.5,744.2,1894.5
                c0.4,1.8-174.5,73.5-179.3,73.5C671.6,2304,520.2,1872.8,335.8,1345.9L335.8,1345.9z" />
            <path fill="#0A0" d="M479.2,1092.4c-221.5-563.1-287.6-732-286.8-733.3c7.9-12.8,103.4-85.2,156.3-118.6
