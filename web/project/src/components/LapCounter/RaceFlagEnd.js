...
//https://en.wikipedia.org/wiki/Racing_flags#The_chequered_flag

const RaceFlagEnd = ({onSelect}) => {

    const clickFlag = () => {
        console.log("Race End Flag Clicked");
        onSelect();
    }

    return (
        <button id="btnEndRace" className="button" onClick={clickFlag}>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" fill="#FFF" width="100"
                viewBox="0 0 1280.000000 1228.000000" preserveAspectRatio="xMidYMid meet">
